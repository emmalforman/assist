  ...
  return (
    <aside className="w-64 bg-sidebar-bg text-sidebar-text flex flex-col min-h-screen">
      <div className="px-6 py-6">
        <h1 className="text-xl font-bold tracking-tight">Myca</h1>
        <p className="text-xs text-zinc-500 mt-0.5">Event Growth Engine</p>
      </div>
      ...
      <div className="px-6 py-4 border-t border-white/10">
        <p className="text-xs text-zinc-500">Myca v0.1.0</p>
      </div>
    </aside>
  );
}
